...
<main role="main">
  ...
  <section>
    <a href="<?= $data['prev_page'] ?> "><input type="button" style="width: 200px;" class="s-12 submit-form button background-primary text-white" name="" value="Prev"></a>
    <a href="<?= $data['next_page'] ?>"><input type="button" style="width: 200px; float: right;" class="s-12 submit-form button background-primary text-white" name="" value="Next"></a>
  </section>
</main>
